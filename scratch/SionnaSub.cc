...
main(int argc, char* argv[])
{
    ...
    RtPathSolverConfig.maxDepth = 4;              // Maximum reflection/refraction depth
    ...
    RtPathSolverConfig.diffraction = true;       // Enable diffraction
    RtPathSolverConfig.edge_diffraction = false;  // Disable edge diffraction
    RtPathSolverConfig.refraction = true;         // Disable refractions
