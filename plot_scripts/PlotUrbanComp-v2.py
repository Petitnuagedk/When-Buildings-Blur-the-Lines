...
plot_metric_by_loss_model(num_nodes_list, average_metrics_across_epochs["pdr_vs_nodes"], "Packet Delivery Ratio", "PDR vs. Number of Nodes", "Number of Nodes", "pdr_vs_nodes", yerr_data=average_metrics_std_across_epochs["pdr_vs_nodes"], ylim=pdr_ylim)
plot_metric_by_loss_model(num_nodes_list, average_metrics_across_epochs["eed_vs_nodes"], "End-to-End Delay", "EED vs. Number of Nodes", "Number of Nodes", "eed_vs_nodes", yerr_data=average_metrics_std_across_epochs["eed_vs_nodes"], ylim=eed_ylim)
plot_metric_by_loss_model(num_nodes_list, average_metrics_across_epochs["goodput_vs_nodes"], "Goodput (kb/s)", "Goodput vs. Number of Nodes", "Number of Nodes", "goodput_vs_nodes", yerr_data=average_metrics_std_across_epochs["goodput_vs_nodes"], ylim=goodput_ylim)
...
plot_route_acquisition_time(num_nodes_list, average_route_acquisition, stddev_route_acquisition, "Route Acquisition Time (s)", "Route Acquisition Time vs Number of Nodes (AODV)", "Number of Nodes", "route_acquisition_time_aodv", ylim=route_acq_ylim)
